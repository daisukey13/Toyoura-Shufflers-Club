...
export default function HomePage() {
  ...
  const { refreshAuth, user, player, loading } = useAuth();
  ...
  const fetchStats = async () => {
    try {
      ...
      if (playersResult.data) {
        ...
        const avgPoints =
          playersResult.data.reduce((sum, p) => sum + p.ranking_points, 0) /
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-4 py-8 sm:py-12">
              ...
              <Link key={index} href={item.href}>
                ...
                >
                  <div className="flex flex-col items-center text-center">
                    ...
                    <h3 className="text-base sm:text-lg font-semibold mb-1 sm:mb-2 text-yellow-100">
                      {item.title}
                    </h3>
              ...
              <Link key={player.id} href={`/players/${player.id}`}>
                <div className="glass-card rounded-xl p-4 sm:p-6 hover:scale-105 transition-transform cursor-pointer">
                  ...
                  <div className="text-center">
                    <div className="text-xl sm:text-2xl font-bold text-yellow-100">
                      {player.ranking_points}pt
                    </div>
                  </div>
                </div>
              </Link>
        ...
        {/* 最近の試合 - モバイル対応 */}
        <div>
          <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 flex itemsセンター gap-2 text-yellow-100">
          ...
          <div className="space-y-3">
            {recentMatches.slice(0, 3).map((match) => {
              ...
              return (
                <div
                  key={match.id}
                  className={`glass-card rounded-lg p-3 sm:p-4 relative ${
                ...
                >
                  ...
                  <div className="text-center mb-2 sm:mb-3">
                    <div
                      className={`text-xl sm:text-2xl font-bold text-yellow-100 ${
                        isUpset ? 'mt-5 sm:mt-6' : 'mt-1 sm:mt-2'
                      }`}
                    >
                  ...
                  <div className="flex items-center justify-between gap-2">
                    <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        <div className="font-medium text-yellow-100 text-sm sm:text-base truncate">
                          {match.winner_name}
                        </div>
      ...
      {showLoginModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
          ...
          <div className="relative glass-card rounded-2xl p-6 sm:p-8 max-w-md w-full">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-yellow-100 mb-4 sm:mb-6 text-center">
              ログイン
            </h2>

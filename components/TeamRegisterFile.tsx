      ...
      {loading ? (
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-sm text-gray-300 mb-1">勝利チーム</label>
              <select
                value={winnerId}
            ...
            <div>
              <label className="block text-sm text-gray-300 mb-1">敗北チーム</label>
              <select
                value={loserId}
          ...
          <div className="grid grid-cols-3 gap-3">
            <div>
              <label className="block text-sm text-gray-300 mb-1">敗者の得点 (0–14)</label>
              <input
                type="number"
                min={0}
                max={14}
            ...
            <div className="col-span-2">
              <label className="block text-sm text-gray-300 mb-1">会場（任意）</label>
              <input
                value={venue}
          ...
          <div>
            <label className="block text-sm text-gray-300 mb-1">メモ（任意）</label>
            <textarea
              value={notes}

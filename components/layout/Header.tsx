...
import {
  FaBars, FaTimes, FaTrophy, FaUsers, FaChartLine, FaUserPlus, FaHistory, FaCog, FaUserCircle, FaSignOutAlt, FaSignInAlt
} from 'react-icons/fa';
...
export default function Header() {
  ...
  const StatusDot = ({
    ...
    className = '',
    label,
  }: { size?: string; ring?: string; className?: string; label?: string }) => {
      ...
      <nav className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          >
            ...
            {/* トグルボタンの右上にも状態ドットを表示 */}
            <StatusDot size="h-2 w-2" ring="ring-2 ring-gray-900" className="absolute -top-0.5 -right-0.5" />
          </button>
        </div>
